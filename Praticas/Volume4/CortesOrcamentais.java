import java.util.*;
/*-----MooshackDAA-Vol4-Prog G-Cortes CortesOrcamentais--- Terminado
  ...
  Nota: Semelhante a Transporte de Luxo (Prob F)
    -Posso aplicar um alg de Dijsktra para heapMin e ver se o valor obtido é menor ou igual ao orça
------------------//-------------------------------------
    INPUT:
      L1: 4 inteiros: tempMin tempMax origem destino (origem != destino)
      L2: #nos #ramos da rede (grafo de 2 pesos)
      -->Desc de ramos bidirecionais  n<=20000 r<=5000
          -4 ints: exInicial exFinal temperaturaRamo custoTransporte
      L(n+1): nCenarios--#cenarios a considerar >=1
      -->Desc de cenários: cada linha diz valor maximo a dispensar <10000

    OUTPUT: para cada cenario
      - "Sim"-pode ser feito transporte sem ultrapassar montante
      - "Nao"-caso contrário
